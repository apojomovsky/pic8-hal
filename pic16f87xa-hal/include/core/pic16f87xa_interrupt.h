...
#ifndef PIC16F87XA_INTERRUPT_H
#define PIC16F87XA_INTERRUPT_H
...
typedef enum {
    ...
    PIC16F87XA_IRQ_INT      = 1,  /**< External INT (RB0).        */
    PIC16F87XA_IRQ_TMR0     = 2,  /**< Timer0 overflow.           */
    PIC16F87XA_IRQ_TMR1     = 3,  /**< Timer1 overflow.           */
    PIC16F87XA_IRQ_TMR2     = 4,  /**< Timer2 == PR2 match.       */
    PIC16F87XA_IRQ_CCP1     = 5,  /**< CCP1 capture/compare.      */
    PIC16F87XA_IRQ_CCP2     = 6,  /**< CCP2 capture/compare.      */
    PIC16F87XA_IRQ_SSP      = 7,  /**< SSP (TX/RX/I²C activity).  */
    PIC16F87XA_IRQ_BCL      = 8,  /**< SSP bus collision.         */
    PIC16F87XA_IRQ_USART_TX = 9,  /**< USART TX shift done.       */
    PIC16F87XA_IRQ_USART_RX = 10, /**< USART RX byte ready.       */
    PIC16F87XA_IRQ_ADC      = 11, /**< A/D conversion done.       */
    PIC16F87XA_IRQ_EEPROM   = 12, /**< EEPROM write complete.     */
    PIC16F87XA_IRQ_CMP      = 13, /**< Comparator output change.  */
#if PIC16F87XA_FAMILY_HAS_PSP
    PIC16F87XA_IRQ_PSP      = 14, /**< Parallel Slave Port.       */
#endif
