/**
 * @file    peripherals/pic18f2455_timer3.h
 ...
 *   `pic18f2455_timer1.h` (same `TIMER3_HandleTypeDef`, `HAL_TIMER3_*`
...
#ifndef PIC18F2455_TIMER3_H
#define PIC18F2455_TIMER3_H
