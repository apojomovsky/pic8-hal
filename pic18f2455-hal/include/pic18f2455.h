...
/**
 * @defgroup  PIC18F2455_Device Device Selection
...
#error "Define exactly one of PIC18F2455 / PIC18F2550 / PIC18F4455 / PIC18F4550."
  ...
  #define PIC18F2455_FAMILY_FLASH_BYTES    24576U  /**< 24 KB.             */
  #define PIC18F2455_FAMILY_FLASH_INSTR    12288U
  #define PIC18F2455_FAMILY_RAM_BYTES      2048U
  #define PIC18F2455_FAMILY_EEPROM_B       256U
  #define PIC18F2455_FAMILY_IO_PINS        24U
  #define PIC18F2455_FAMILY_ADC_CH         10U
  #define PIC18F2455_FAMILY_HAS_PORTD      0
  #define PIC18F2455_FAMILY_HAS_PORTE      0
  #define PIC18F2455_FAMILY_HAS_SPP        0
  #define PIC18F2455_FAMILY_HAS_USB        1
  #define PIC18F2455_DEVICE_NAME           "PIC18F2455"
#elif defined(PIC18F2550)
  #define PIC18F2455_FAMILY_FLASH_BYTES    32768U  /**< 32 KB.             */
  #define PIC18F2455_FAMILY_FLASH_INSTR    16384U
  #define PIC18F2455_FAMILY_RAM_BYTES      2048U
  #define PIC18F2455_FAMILY_EEPROM_B       256U
  #define PIC18F2455_FAMILY_IO_PINS        24U
  #define PIC18F2455_FAMILY_ADC_CH         10U
  ...
  #define PIC18F2455_FAMILY_HAS_SPP        0
  #define PIC18F2455_FAMILY_HAS_USB        1
  #define PIC18F2455_DEVICE_NAME           "PIC18F2550"
#elif defined(PIC18F4455)
  #define PIC18F2455_FAMILY_FLASH_BYTES    24576U  /**< 24 KB.             */
  #define PIC18F2455_FAMILY_FLASH_INSTR    12288U
  #define PIC18F2455_FAMILY_RAM_BYTES      2048U
  #define PIC18F2455_FAMILY_EEPROM_B       256U
  #define PIC18F2455_FAMILY_IO_PINS        35U
  #define PIC18F2455_FAMILY_ADC_CH         13U
  #define PIC18F2455_FAMILY_HAS_PORTD      1
  #define PIC18F2455_FAMILY_HAS_PORTE      1
  #define PIC18F2455_FAMILY_HAS_SPP        1
  #define PIC18F2455_FAMILY_HAS_USB        1
  #define PIC18F2455_DEVICE_NAME           "PIC18F4455"
#else  /* PIC18F4550 */
  #define PIC18F2455_FAMILY_FLASH_BYTES    32768U  /**< 32 KB.             */
  #define PIC18F2455_FAMILY_FLASH_INSTR    16384U
  #define PIC18F2455_FAMILY_RAM_BYTES      2048U
  ...
  #define PIC18F2455_FAMILY_HAS_SPP        1
  #define PIC18F2455_FAMILY_HAS_USB        1
  #define PIC18F2455_DEVICE_NAME           "PIC18F4550"
#endif
/** @} */
 ...
 * family. Pulled in here so a single `#include "pic18f2455.h"` gives the
...
/**
 * @defgroup PIC18F2455_SFR Special Function Register mapping
