 ...
 *   single neutral header instead of the family-specific `pic18f2455.h`.
...
#include "pic18f2455.h"       /* standard types, status codes, platform   */
#include "pic18f2455_sfr.h"   /* SFR address map + bit definitions       */
